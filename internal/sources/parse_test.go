...
func TestParseImportSchema1(t *testing.T) {
	...
	if _, err := ParseImport([]byte(`{"schemaVersion":1,"importId":"aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa","extra":true,"environmentTemplates":[],"executionProfiles":[],"defaultBindings":[]}`)); err == nil {
