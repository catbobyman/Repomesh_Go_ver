...
记录：2026-09-10。本记录由页面／接口／后端文档负责人维护，说明本轮阅读覆盖和文档同步；不是主要实现者之外的代码独立复核，也不是业务或 AgentTeams 集成验收。工程结构、启动、配置和构建以[基础工程开发说明](development-scaffold.md)为统一入口，最终状态见 [HANDOFF](HANDOFF.md)。
...
| [conversation-issue-separation-design.md](conversation-issue-separation-design.md) | 独立 Issue 页面与真实房间导航。 |
| [conversation-message-target-design.md](conversation-message-target-design.md) | 明确自然语言目标、澄清和晚到结果归属。 |
| [manager-create-issue-tool-design.md](manager-create-issue-tool-design.md) | 双入口统一命令、可信来源、MCP 未完成范围。 |
| [issue-page-create-api-contract.md](issue-page-create-api-contract.md) | 现行 REST、Issue SSE、幂等和来源设计基线。 |
| [draft-conversation-backend-design.md](draft-conversation-backend-design.md) | 事务、消息保存、运行准备及恢复职责。 |
...
| [project-configuration-design.md](project-configuration-design.md) | 配置、账号与 App 能力、部分失权。 |
| [issue-creation-repository-analysis.md](issue-creation-repository-analysis.md) | 建项前分析、建议应用、固定输入与来源。 |
...
| [design-delegation.md](design-delegation.md) | 持续设计授权原范围、P1—P4 采用记录。 |
