...
| 前端／接口与后端分工 | [页面交接](current/HANDOFF-PAGE-API-DESIGN.md)、[后端交接](current/HANDOFF-BACKEND-DESIGN.md) |
| AgentTeams 调研及实测边界 | [09-07 调研](agentteams-survey-2026-09-07/agentteams-survey.md)、[证据索引](current/scaffold-agentteams-evidence.md) |
| 设计审查与修订验证 | [原始审查](reviews/2026-09-12-design-readiness/README.md)、[修订验证](reviews/2026-09-12-design-fixes/README.md) |
| 旧文档、原话和归档映射 | [本次归档](archive/2026-09-12-development-preparation/README.md)、[全部历史归档](archive/README.md) |

采用状态按具体章节和后续替代关系判断；proposed 和 deferred 不等于无用。当前 ADR、唯一契约、关键候选和必要证据入口保持可查，本次归档不改变产品决定或宣布业务完成。
