...
RUN_DIR_UNC = r"\\wsl.localhost\Ubuntu-22.04\home\xubohan\projects\Repomesh_Go_ver\docs\development\2026-09-12-b026-refresh-01"
...
def parse_time(value):
    ...
    try:
        ...
        raise ControlledFailure("INVALID_TIMESTAMP") from exc
